...
Determine when to use MongoDB API, Azure Cosmos DB SQLDocumentDB API, Graph API, Azure Tables API; design for cost, performance, data consistency, availability, and business continuity 
...
Determine when to use Azure Automation, Chef, Puppet, PowerShell, Desired State ConfigurationAzure Automation (DSC), Event Grid, and Azure Logic Apps; define a strategy for auto-scaling; define a strategy for enabling periodic processes and tasks; define an update management strategy
